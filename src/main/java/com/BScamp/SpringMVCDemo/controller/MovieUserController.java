...
public class MovieUserController {
	...
	public void saveUserInfo(@ModelAttribute("user") MovieUser movieUser, HttpServletResponse response) throws IOException {
	...
	public ModelAndView loginCheck(@RequestParam("gmail") String gmail, @RequestParam("password") String password, HttpSession session) {
		ModelAndView mv= new ModelAndView();
